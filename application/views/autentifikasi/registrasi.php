                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('autentifikasi/registrasi'); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" id="password2" name="password2" placeholder="Ulangi Password" autocomplete="off">
                                    <?= form_error(
                                        'password2',
                                        '<small class="text-danger pl-3">',
                                        '</small>'
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('home'); ?>">Halaman Awal</a>
                        </div>
                    </div>
                </div>
            </div>
